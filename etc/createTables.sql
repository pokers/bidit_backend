...
CREATE TABLE IF NOT EXISTS itemDetail (
    ...
    type        VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    vendor      VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    battery     VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    flash       VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    ram         VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    size        VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    networkType VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    weight      VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    cpu         VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    wire        VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    lens        VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    resolution  VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    cam         VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    warranty    VARCHAR(16) CHARACTER SET UTF8MB4 NULL,
    createdAt   DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updatedAt   DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deletedAt   DATETIME NULL,
    PRIMARY KEY(id),
    CONSTRAINT fk_item_itemDetail FOREIGN KEY(itemId) REFERENCES item(id),
    CONSTRAINT fk_category_itemDetail FOREIGN KEY(categoryId) REFERENCES category(id),
    INDEX period(period),
    INDEX type(type),
...
CREATE TABLE IF NOT EXISTS dibs (
    ...
    deletedAt   DATETIME NULL,
    PRIMARY KEY(id),
    CONSTRAINT fk_user_dibs FOREIGN KEY(userId) REFERENCES user(id),
    CONSTRAINT fk_item_dibs FOREIGN KEY(itemId) REFERENCES item(id)
);
